  ...
  it.each([
    {
      PageComponent: EnglishCoatOfArmsMakerPage,
      canonical: '/coat-of-arms-maker',
      contentHeading: 'Coat of Arms Maker: Free Online Fantasy and Guild Badges',
      metadata: englishCoatOfArmsMakerMetadata,
      metadataTitle: 'Coat of Arms Maker: Free Online Fantasy and Guild Badges',
      schemaDescription:
      ...
      twitterDescription:
        'Draw your own fantasy shields and guild badges in this free online coat of arms maker, then export PNG, JPEG, or PDF.',
      twitterTitle: 'Coat of Arms Maker: Free Online Fantasy and Guild Badges',
    ...
    },
    {
      PageComponent: ChineseCoatOfArmsMakerPage,
      canonical: '/zh/coat-of-arms-maker',
      contentHeading: '纹章制作器：免费在线做奇幻与公会徽章',
      metadata: chineseCoatOfArmsMakerMetadata,
      metadataTitle: '纹章制作器：免费在线做奇幻与公会徽章',
      schemaDescription: '在这款免费在线纹章制作器里自己画奇幻盾牌和公会徽章，再导出 PNG、JPEG 或 PDF。',
      schemaFeatures: [
        '盾牌样式与底纹',
        '图形、文字、图层和绘图工具',
      ...
      twitterDescription: '在这款免费在线纹章制作器里自己画奇幻盾牌和公会徽章，再导出 PNG、JPEG 或 PDF。',
      twitterTitle: '纹章制作器：免费在线做奇幻与公会徽章',
      projectName: '我的徽章',
      workspaceName: '徽章制作工作台',
    },
