...
const workbenchCopyByLocale: Record<CoatLocale, CoatWorkbenchCopy> = {
  en: {
    ...
    panels: {
      ...
      names: 'Names', generatedProjectName: 'Generated project name', generatedMotto: 'Generated motto', generateIdentity: 'Generate identity', nameGeneratorType: 'Name type', nameGeneratorLanguage: 'Language', nameGeneratorLanguages: { en: 'English', de: 'German' }, nameGeneratorTypes: { city: 'City', cult: 'Cult', demon: 'Demon', dragon: 'Dragon', dwarf: 'Dwarf', elven: 'Elven', 'fantasy-kingdom': 'Fantasy Kingdom', gods: 'Gods', knight: 'Knight', orc: 'Orc', 'pirate-ship': 'Pirate Ship', realm: 'Realm', 'roman-province': 'Roman Province', tavern: 'Tavern' }, nameResults: 'Generated names', generateNames: (typeName) => `Generate ${typeName} Names`, identityActions: 'Project identity actions', useProjectName: 'Use project name', addGeneratedMotto: 'Add generated motto',
  ...
  zh: {
    ...
    panels: {
      ...
      names: '命名', generatedProjectName: '生成的项目名称', generatedMotto: '生成的格言', generateIdentity: '生成名称与格言', nameGeneratorType: '名称类型', nameGeneratorLanguage: '语言', nameGeneratorLanguages: { en: '英语', de: '德语' }, nameGeneratorTypes: { city: '城市', cult: '教派', demon: '恶魔', dragon: '巨龙', dwarf: '矮人', elven: '精灵', 'fantasy-kingdom': '幻想王国', gods: '诸神', knight: '骑士', orc: '兽人', 'pirate-ship': '海盗船', realm: '领域', 'roman-province': '罗马行省', tavern: '酒馆' }, nameResults: '生成的名称', generateNames: (typeName) => `生成${typeName}名称`, identityActions: '项目身份操作', useProjectName: '使用项目名称', addGeneratedMotto: '添加生成的格言',
