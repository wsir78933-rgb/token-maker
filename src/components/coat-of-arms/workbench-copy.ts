...
const workbenchCopyByLocale: Record<CoatLocale, CoatWorkbenchCopy> = {
  en: {
    ...
    shell: {
      ...
      collapseToolPanel: 'Collapse tool panel', expandToolPanel: 'Expand tool panel', multiSelect: 'Multi-select',
  ...
  zh: {
    ...
    shell: {
      ...
      collapseToolPanel: '收起工具面板', expandToolPanel: '展开工具面板', multiSelect: '多选',
    ...
    panels: {
      ...
      settings: '设置', appearance: '外观', appearanceDark: '深色', appearanceLight: '浅色', colorPicker: '取色器', colorPickerSimple: '简单', colorPickerAdvanced: '高级', colorPickerHelp: '简单模式用连续色板，并始终显示取色器。高级模式按纹章类别分组色板。', heraldicSwatchGroups: { metals: '金属色', colours: '正色', stains: '染色', other: '其他' }, canvasSize: '画布尺寸', canvasWidth: '宽度', canvasHeight: '高度', applyCanvasSize: '应用', resetEditor: '重置编辑器', canvasPresets: '画布预设', canvasPresetNames: { square: '方形', 'instagram-story': 'Instagram Story / TikTok', 'facebook-image': 'Facebook 图片', 'twitter-image': 'Twitter 图片', pinterest: 'Pinterest' }, canvasPresetSize: (width, height) => `${width} x ${height}`,
