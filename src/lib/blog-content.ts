...
const dndClassesArticle: BlogPost = {
  ...
  relatedSlugs: ['dnd-classes-ranked'],
  featured: true,
};
...
const dndClassesRankedArticle: BlogPost = {
  ...
  relatedSlugs: ['dnd-classes-explained'],
};
...
const postsByLocale: Record<SiteLocale, BlogPost[]> = {
  en: [dndClassesArticle, dndClassesRankedArticle, dndTokenGuideArticle, dndSmallPartyGuideArticle].map(
    addHeadingAnchors,
  ),
  zh: [dndClassesArticleZh, dndClassesRankedArticleZh, dndTokenGuideArticleZh, dndSmallPartyGuideArticleZh].map(
    addHeadingAnchors,
  ),
};
